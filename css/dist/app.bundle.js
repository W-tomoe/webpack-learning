...
/******/ 		return __webpack_require__.p + "" + ({"0":"a"}[chunkId]||chunkId) + ".bundle.js"
/******/ 	}
/******/
...
/* harmony import */ var _css_base_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
...
__webpack_require__.e(/* import() | a */ 0).then(__webpack_require__.bind(null, 8)).then(function (a) { 
    console.log(a,'a')
})
...
// Exports
exports.locals = {
	"box": "src-css--base_1dC2 " + __webpack_require__(1).locals["bigBox"] + ""
};
